...
Run with PYTHONPATH=src, OPENAI_API_KEY, --base-url and --report. Only synthetic
inputs are sent to the model. No mounts or host credentials enter containers;
every container created by this probe is recorded and removed before exit.
"""
...
class ReportingBackend:
    ...
    def __init__(self, name):
        ...
        self.backend = Sandbox.container(
            **CONFIG, network=False, timeout_seconds=10, max_output_bytes=65536,
