...
See the canonical [model configuration guide](https://usefused.com/docs/harnest/build/models-and-libraries/configure-a-model). Never put credential values in `spec.environment`, agent source, or `evals/test_config.json`.
